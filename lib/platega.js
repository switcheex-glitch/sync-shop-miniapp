...
// card = 10 (CardsRub — карты РФ: МИР/Visa/Mastercard). Если карта не проходит —
// у Platega это может быть 11 (CardAcquiring, «общий эквайринг»): поменяйте здесь.
export const PLATEGA_METHODS = { sbp: 2, card: 10, crypto: 13 };
