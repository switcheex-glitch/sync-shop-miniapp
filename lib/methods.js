...
// СБП +5.5%, SberPay +6%, карта РФ +6%, крипта +4%, зарубежная карта +13% —
// тарифы снижены 04.09.2026 (было 7 / 7 / 8 / 4 / 15). Показываются в UI как
// «комиссия провайдера» и входят в «итого».
// Проверено 04.09.2026 на боевом шлюзе: на запрос 1000 ₽ Platega выставляет
// 1055 ₽ по СБП и 1130 ₽ по международной карте (поле comission = 55 и 130).
// Надбавка перенесена на покупателя по ОБОИМ методам — старое предупреждение
// от 17.08.2026 об обратном больше не действует.
export const PAY_METHODS = [
  { key: 'sbp', code: 2, feePct: 5.5, icon: 'qr', title: 'СБП (QR-код)', sub: 'Оплата по QR через банк' },
  { key: 'sberpay', code: 14, feePct: 6, icon: 'sber', title: 'SberPay', sub: 'Оплата в приложении Сбербанка' },
  { key: 'card', code: 11, feePct: 6, icon: 'card', title: 'Банковская карта РФ', sub: 'МИР, Visa, Mastercard, UnionPay банков РФ' },
