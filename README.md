...
- Витрина открыта без барьера; согласие с EULA + Политикой принимается галочкой на шаге «Условия» маршрута покупки → запись в `consents` (до создания платежа).
...
lib/
  ...
  payFaq.js                  текст экрана «Как оплатить» (инструкции, банки КЗ/БР, крипта)
